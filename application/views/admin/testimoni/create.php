<div class="container-fluid">
    ...
    <div class="card card-body shadow-sm mt-4">
        ...
        ?>
        <?= form_open('admin/testimoni/create', 'onsubmit="disable()"'); ?>
        <div class="row">
            <div class="col-lg-6 col-sm-12 mb-3">
                <label class="bold">Nama Alumni</label>
                <input type="text" name="name" class="form-control" placeholder="Nama alumni" autocomplete="off">
                <?= form_error('name', '<span class="text-danger bold">', '</span>'); ?>
            </div>
            <div class="col-lg-6 col-sm-12 mb-3">
                <label class="bold">Stambuk</label>
                <input type="number" name="stambuk" class="form-control" placeholder="Stambuk" autocomplete="off">
                <?= form_error('stambuk', '<span class="text-danger bold">', '</span>'); ?>
            </div>
            <div class="col-lg-6 col-sm-12 mb-3">
                <label class="bold">Testimoni</label>
                <textarea name="testimoni" class="form-control" placeholder="Testimoni"></textarea>
                <?= form_error('testimoni', '<span class="text-danger bold">', '</span>'); ?>
            </div>
            <div class="col-lg-6 col-sm-12 mb-3">
                <label class="bold">Pekerjaan</label>
                <input type="text" name="whois" class="form-control" placeholder="Pekerjaan" autocomplete="off">
