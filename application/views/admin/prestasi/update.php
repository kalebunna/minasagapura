<div class="container-fluid">
    ...
    <div class="card card-body shadow-sm mt-4">
        ...
        ?>
        <?= form_open_multipart('admin/prestasi/update/' . $prestasi['id'], 'onsubmit="disable()"'); ?>
        <div class="row">
            <div class="col-lg-6 col-sm-12">
                <label class="bold">Judul prestasi</label>
                <input type="text" name="title" class="form-control" placeholder="Nama prestasi" autocomplete="off" value="<?= $prestasi['title']; ?>">
                <?= form_error('title', '<span class="text-danger bold">', '</span>'); ?>
            </div>
            <div class="col-lg-6 col-sm-12">
                <label class="bold">Deskripsi singkat</label>
                <textarea name="description" class="form-control" placeholder="Deskripsi singkat"><?= $prestasi['description']; ?></textarea>
        ...
        <textarea name="content" class="form-control mb-3" id="summernote"><?= $prestasi['content']; ?></textarea>
