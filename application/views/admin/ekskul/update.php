<div class="container-fluid">
    ...
    <div class="card card-body shadow-sm mt-4">
        ...
        ?>
        <?= form_open_multipart('admin/ekskul/update/' . $ekskul['id'], 'onsubmit="disable()"'); ?>
        <label class="bold">Nama ekstrakurikuler</label>
        <input type="text" name="name" value="<?= $ekskul['name']; ?>" class="form-control" placeholder="Nama ekstrakurikuler" autocomplete="off">
        <?= form_error('name', '<span class="text-danger bold">', '</span>'); ?>

        <div class="pt-3"></div>
        <label class="bold">Deskripsi</label>
        <textarea name="description" id="summernote" class="form-control" placeholder="Deskripsi"><?= $ekskul['description']; ?></textarea>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <input type="text" name="lead" value="<?= $ekskul['lead']; ?>" class="form-control" placeholder="Nama guru pembimbing" autocomplete="off">
