...
<head>
    ...
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/templates_admin/css/vendors/flag-icon.css">
    <!-- Feather icon-->
                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="cart-nav onhover-dropdown">
                            ...
                            <ul class="cart-dropdown onhover-show-div">
                                ...
                                <li class="mt-0">
                                    <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="<?= base_url() ?>assets/templates_admin/images/ecommerce/01.jpg" alt="">
                                ...
                                <li class="mt-0">
                                    <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="<?= base_url() ?>assets/templates_admin/images/ecommerce/03.jpg" alt="">
                                        <div class="media-body"><span>V-Neck Shawl Collar Woman's Solid T-Shirt</span>
                                            <p>Yellow(#fcb102)</p>
                                            <div class="qty-box">
                                                <div class="input-group"><span class="input-group-prepend">
                        ...
                        <li class="onhover-dropdown"><i data-feather="message-square"></i>
                            <ul class="chat-dropdown onhover-show-div">
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3" src="<?= base_url() ?>assets/templates_admin/images/user/1.jpg" alt="">
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3" src="<?= base_url() ?>assets/templates_admin/images/user/2.jpg" alt="">
                                        <div class="status-circle online"></div>
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3" src="<?= base_url() ?>assets/templates_admin/images/user/4.jpg" alt="">
