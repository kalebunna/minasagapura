...
<head>
    ...
    <link href="<?= base_url() ?>/assets/templates_admin/vendor/jquery-nice-select/css/nice-select.css" rel="stylesheet">
    <link href="<?= base_url() ?>/assets/templates_admin/css/style.css" rel="stylesheet">
