<div class="container-fluid">
    ...
    <div class="card card-body shadow-sm mt-4">
        ...
        <?= form_open('admin/edit/sambutan_yayasan', 'onsubmit="disable()"'); ?>
        <label class="bold">Deskripsi singkat</label>
        <textarea name="description" class="form-control" placeholder="Deskripsi singkat"><?= $sambutan['description']; ?></textarea>
